...
(default,"Pintura Garagem","95 metros de paredes, material(tintas) já comprada pelo proprietário","Condomínio Quinta do Conte BL03 AP21, Jaguariúna - SP", 8),
(default,"Reforma Banheiro","Troca completa do piso, revestimento utencílios","Avenida Brasil, 41, Centrom, Jaguariúna - SP", 80),
(default,"Reparo em Descarga","Valvula do vaso sanitário com problemas","Rua Silva Bueno, 25, Centro, Jaguariúna - SP", 4),
(default,"Instalar Iluminação","Instalar iluminação no Jardim","Rua Marcos Bueno, 25, Centro, Jaguariúna - SP", 4);
insert into profissionais values
("22200033322","Marcelo Silva","Pedreiro",30),
("22211133322","Severina Silva","Ajudante Geral",30),
("11122233344","Jair Silva","Eletricista",35),
("55566677788","Adolfo Souza","Ajudante Geral",25),
("22211100022","Mariana Mattos","Faxineira",30),
("99900011122","Suzana Melo","Encanador",35),
("33344455566","Beatriz Oliveira","Pedreiro",30),
("77788899900","Paulo Bial","Decorador",50);
