...
('SDS1A21','FIORINO','FIAT','Lanterna esquerda quebrada'),
...
("DDD1A11",curdate()-2,date_add(now(),interval - 3 hour),date_add(now(),interval - 1 hour),5),
...
("DDD1A11",curdate()-2,date_add(now(),interval + 1 hour),date_add(now(),interval + 2 hour),10),
("AAA1A22",curdate()-2,date_add(now(),interval + 2 hour),date_add(now(),interval + 4 hour),11),
("AAA1A32",curdate()-2,date_add(now(),interval + 3 hour),date_add(now(),interval + 4 hour),10),
...
("CDC1A21",curdate()-1,date_add(now(),interval - 4 hour),date_add(now(),interval - 1 hour),5),
("DDD1A21",curdate()-1,date_add(now(),interval - 3 hour),date_add(now(),interval - 1 hour),4),
...
("FDF1A21",curdate()-1,date_add(now(),interval + 1 hour),date_add(now(),interval + 3 hour),12),
("AAA1A11",curdate()-1,date_add(now(),interval + 1 hour),date_add(now(),interval + 2 hour),13),
...
("AAA1A55",curdate(),date_add(now(),interval - 5 hour),date_add(now(),interval - 3 hour),17),
("BBC1A21",curdate(),date_add(now(),interval - 5 hour),date_add(now(),interval - 4 hour),18),
...
("DDD1A21",curdate(),date_add(now(),interval - 3 hour),date_add(now(),interval - 1 hour),3),
