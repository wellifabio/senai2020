...
SELECT * FROM Compras INTO OUTFILE 'D:/ARQUIVOS/SENAI/Planos_Ensino/2020_2_Semestre/BD/Aula6/Compras.csv' FIELDS TERMINATED BY ';' ENCLOSED BY '"' LINES TERMINATED BY '\n';
