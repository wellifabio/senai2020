...
-- Criar o relacionamento alterando a tabela "Fraca"
...
insert into Compras
values
    (default, "	2020-06-28	", "	06:20	", 2	, 100	, 2.99	);
insert into Compras
values
    (default, "	2020-06-28	", "	06:22	", 2	, 10	, 2.99	);
insert into Compras
values
    (default, "	2020-06-29	", "	06:23	", 4	, 20	, 0.1	);
insert into Compras
values
    (default, "	2020-06-29	", "	06:20	", 2	, 100	, 2.99	);
insert into Compras
values
    (default, "	2020-06-29	", "	06:22	", 2	, 10	, 2.99	);
insert into Compras
values
    (default, "	2020-06-29	", "	06:23	", 4	, 20	, 0.1	);
insert into Compras
values
    (default, "	2020-06-30	", "	06:20	", 2	, 100	, 2.99	);
insert into Compras
values
    (default, "	2020-06-30	", "	06:22	", 2	, 10	, 2.99	);
insert into Compras
values
    (default, "	2020-06-30	", "	06:23	", 4	, 20	, 0.1	);
insert into Compras
values
    (default, "	2020-07-01	", "	09:39	", 8	, 2	, 13.45	);
insert into Compras
values
    (default, "	2020-07-20	", "	10:46	", 4	, 100	, 0.1	);
insert into Compras
values
    (default, "	2020-08-03	", "	08:38	", 1	, 12	, 0.99	);
